...
titles = ["17 Dec 2014 06UTC","18 Dec 2014 06UTC","19 Dec 2014 06UTC","20 Dec 2014 06UTC","21 Dec 2014 06UTC"]
axes = []
...
for i in range(5):
    ...
    contourf = ax.contourf(to_np(lons), to_np(lats), to_np(wind_speed[times[i]+6,:,:]),range(0,71,10),
...
cbar = plt.colorbar(contourf, ax=axes, shrink=.33, orientation="horizontal",anchor=(1.0,4.0))
cbar.ax.set_xlabel("400 hPa wind speed [m/s]")

plt.savefig("wind_d01.pdf",bbox_inches = 'tight')
