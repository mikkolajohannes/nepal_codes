...
#    plt.plot(lon_perp_ncop,lat_perp_ncop,'k.',markersize=12,transform=crs.PlateCarree())
#    plt.plot(lon_UV_ncop,lat_UV_ncop,'r.',markersize=12,transform=crs.PlateCarree())

    # Set the map bounds
#    ax.set_xlim(to_np(lim1[0]),to_np(lim2[0]))
#    ax.set_ylim(to_np(lim1[1]),to_np(lim2[1]))
...
#    ax.add_feature(country_borders, edgecolor='k', linestyle="-", linewidth=1)
    ...
    plt.savefig("valleys.pdf",bbox_inches = 'tight')
